...
export const PRIVATE_RESUME_LIST = [
  {
    ...
    expiryDate: '19 June 2020',
    stats: {
      totalViews: '2',
      totalDownloads: '1',
      averageReadTime: '2m 30s',
      totalLinksShared: '5',
    },
    isOpened: false,
  },
    ...
    projectsSection: [
      {
        ...
        startDate: 'June, 2019',
        endDate: 'Present',
        summary: 'Part of the core team responsible for design of interactive Google Photos platform.',
        point1: '',
        point2: '',
        point3: '',
      },
      {
        ...
        startDate: 'May, 2016',
        endDate: 'Mar, 2018',
        summary: 'Responsible for creating the design system for Tesla new iOS car app.',
        point1: '',
        point2: '',
        point3: '',
      },
    ...
    awardsSection: [
      {
        ...
        summary: 'Won Young Design Award for my contribution as a UI Designer and increasing the conversion rate for their iOS app.',
      },
    ],
  },
};
